...
var CalicoYamlTmpl = template.Must(template.New("calico").Parse(
	dedent.Dedent(`---
...
data:
  ...
  # The CNI network configuration to genie on each node.  The special
  ...
  template:
    ...
    spec:
      ...
      initContainers:
        ...
        - name: genie-cni
          ...
          env:
            ...
            # The CNI network config to genie on each node.
      ...
      volumes:
        ...
        # Used to genie Flex Volume Driver
        - name: flexvol-driver-host
          hostPath:
            type: DirectoryOrCreate
